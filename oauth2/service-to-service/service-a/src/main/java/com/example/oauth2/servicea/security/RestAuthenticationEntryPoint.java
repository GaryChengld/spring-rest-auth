package com.example.oauth2.servicea.security;

import com.example.oauth2.servicea.ApiResponse;
import com.example.oauth2.servicea.HttpUtils;
...
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest httpServletRequest,
        ...
        ApiResponse apiResponse = new ApiResponse(HttpServletResponse.SC_UNAUTHORIZED, this.getExceptionMessage(authException), null);
